...
:: 1. Kiểm tra Python
echo [1/6] Đang kiểm tra môi trường Python...
...
echo [2/6] Đang khởi tạo môi trường ảo (.venv)...
if exist ".venv" (
...
:: 3. Cài đặt thư viện
echo [3/6] Đang cài đặt các thư viện cần thiết (Yêu cầu Internet)...
...
echo [4/6] Đang cài đặt trình duyệt tự động (Playwright)...
...
echo [4.5/6] Đang tải Ngrok (Dùng cho Telegram Webhook)...
if exist "ngrok.exe" (
...
echo [5/6] Đang thiết lập tệp tin cấu hình và Database...
...
echo [6/6] Đang tạo Shortcut trên Desktop...
...
echo 2. Sử dụng Shortcut trên Desktop để Bật/Tắt ứng dụng.
echo.
pause
exit /b 0
